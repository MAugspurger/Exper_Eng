...
def linear_calibration(calibration_time=5, axis=1):
    ...
    """
        ...
        Note: The x-axis is across the short side of the Pico and is positive when the
            USB port is on the left side.  The y-axis is across the long
            side of the Pico, and is positive when the USB port is up.
    """
